...
#-------------------------------------------------------------------------------------------------------
# this script queries our generated database
from database_queries import DatabaseQueries
# this gathers sentiment purely by word frequency ( hard coded just for data base building purposes)
from sentiment_analyzer import SentimentAnalyzer
# this for now just checks for hard coded entities 
...
class SentimentExtractor:
    ...
    def extract_top_examples(self, entity):
        ...
        # Save to file
        filename = f"Dataset/sentiment_examples_{entity.lower().replace(' ', '_')}.json"
